...
public class PlaceAutoCompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Log.i("QUERY", "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            Log.i("QUERY", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            Log.e("QUERY", "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}